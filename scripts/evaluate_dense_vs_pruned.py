...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Compare dense and physically pruned AMCPrune models with lm-evaluation-harness."
    )
...
def main():
    ...
    remove_transformer_blocks(pruned_model, block_path, selected_blocks)
    pruned_model.eval()
